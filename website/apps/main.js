    ...
    return () => {
      ...
      setSearchResults(
        apps
          .map((app) => ({ item: app }))
          .filter((app) => {
            return filterGroup === "home" ? true : app.item.category === filterGroup;
          })
          .sort(
            (a, b) =>
...
const MainScreen = () => {
  ...
  return html`
    ...
    <${Tabs} setFilterGroup=${setFilterGroup} />
  `;
};

const Tabs = ({setFilterGroup}) => {

  return html`<div id="tabs">
    <button onClick=${() => { setFilterGroup("home"); }}>
    ...
    <button onClick=${() => { setFilterGroup("tool"); }}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
    ...
    <button onClick=${() => { setFilterGroup("game"); }}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
